function initialize() {
    ...
    var contentString = '<h2>Marco Zero</h2>' +
        ...
        '<a href="http://pt.wikipedia.org/wiki/Universidade_Tiradentes" target="_blank">clique aqui para mais informações</a>';
...
function loadScript() {
    ...
    script.src = "http://maps.googleapis.com/maps/api/js?key=AIzaSyC6okuHZFamoAOhzlZiGNt1W3boFSMHpzY&sensor=true&callback=initialize";
